...
namespace CasinoSimulator
{
    ...
    class SlotMachineManager
    {
        ...
        public void RunSimulation()
        {
            ...
            // Add credits to play for (users choice)
            int initialCredits = AskPlayerToEnterANumber("Enter number of credits to play for ");
            theSimulator.AddCredits(initialCredits);
            ...
            while (playAgain && (theSimulator.GetCredits() > 0))
            {
                ...
                if (theSimulator.GetCredits() > 0)
                {
                    ...
                    {
                        Console.WriteLine("WARNING! You have less than 10 credits left!yy");
                    }
        ...
        // Run a long simulation, possibly in silent mode
