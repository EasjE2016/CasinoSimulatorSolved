...
namespace CasinoSimulator
{
    ...
    class SlotMachineSimulator
    {
        ...
        // Defines if the simulation should run in silent mode (no printouts)
        ...
        // any two # pays 1
        //
        private const int winningStar3 = 10000;
        ...
        private void PrintMessageBeforeSpin()
        {
            ...
            WriteLineConditional("Spinning, credits left : " + credits);
        }
        ...
        private void PrintOutcomeOfSpin(int winnings)
        {
            ...
            WriteLineConditional("Credits left : " + credits);
        }
        ...
        private string SpinDial()
        {
            ...
            else if (percentage < (probStar + probSeven))
            {
                return "7";
            }
            else if (percentage < (probStar + probSeven + probSharp))
            {
                return "#";
            }
            else
